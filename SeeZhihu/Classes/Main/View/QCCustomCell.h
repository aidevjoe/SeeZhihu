...
@class QCCustomCell, QCCellDataAdapter;

@protocol QCCustomCellDelegate <NSObject>
 ...
 */
- (void)customCell:(QCCustomCell *)cell event:(id)event;
 ...
 */
@property (nonatomic, weak) id <QCCustomCellDelegate>  delegate;

/**
 *  CustomCell's dataAdapter.
 */
@property (nonatomic, weak) QCCellDataAdapter         *dataAdapter;
